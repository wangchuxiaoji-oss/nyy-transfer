...
from app.api.v1.debug_logs import router as debug_logs_router
...
from app.api.v1.video_inspect import router as video_inspect_router

api_v1_router = APIRouter()
api_v1_router.include_router(health_router)
api_v1_router.include_router(auth_router)
api_v1_router.include_router(debug_logs_router)
...
api_v1_router.include_router(video_inspect_router)
